...
class Buffer {
 ...
 public:
  ...
  explicit Buffer(const uint8_t *ptr)
...
struct PlyProperty {
  ...
  explicit PlyProperty(Type type, std::string &_name)
      : name(_name), propertyType(type) {}
  explicit PlyProperty(Type list_type,
                       Type prop_type,
                       std::string &_name,
                       size_t list_count)
      : name(_name),
...
struct PlyElement {
  ...
  explicit PlyElement(const std::string &_name, size_t count)
