...
class MapDrawer {
 public:
  ...
  // void DrawMapPoints();
  // void DrawKeyFrames(const bool bDrawKF, const bool bDrawGraph, const bool
  // bDrawInertialGraph, const bool bDrawOptLba); void
  // DrawCurrentCamera(pangolin::OpenGlMatrix &Twc);
