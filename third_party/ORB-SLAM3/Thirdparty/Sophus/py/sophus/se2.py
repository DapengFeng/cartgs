...
class Se2:
    ...
    def exp(v):
        ...
        t = sophus.Vector2(a * v[0] - b * v[1], b * v[0] + a * v[1])
        return Se2(so2, t)
    ...
    def calc_Dx_this_mul_exp_x_at_0(self, x):
        ...
        return (
            sympy.Matrix(
                4, 3, lambda r, c: sympy.diff((self * Se2.exp(x))[r], x[c])
            )
            .subs(x[0], 0)
            .subs(x[1], 0)
            .limit(x[2], 0)
...
class TestSe2(unittest.TestCase):
    def setUp(self):
        ...
        self.upsilon_theta = sophus.Vector3(upsilon0, upsilon1, theta)
    ...
    def test_matrix(self):
        ...
        self.assertEqual(sympy.simplify(p1_foo - p2_foo), sophus.ZeroVector2())
    ...
    def test_derivatives(self):
        ...
        for i in range(0, 4):
            self.assertEqual(
                sympy.simplify(
                    Se2.calc_Dxi_x_matrix(self.a, i)
    ...
    def test_codegen(self):
        ...
        stream = sophus.cse_codegen(
            self.a.calc_Dx_this_mul_exp_x_at_0(self.upsilon_theta)
        )
