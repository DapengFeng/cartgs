...
class DualQuaternion:
    ...
    def inv(self):
        ...
        return DualQuaternion(
            self.real_q.inv(),
            -self.real_q.inv() * self.inf_q * self.real_q.inv(),
        )
...
class TestDualQuaternion(unittest.TestCase):
    def setUp(self):
        ...
        self.a = DualQuaternion(
            sophus.Quaternion(w, s), sophus.Quaternion(x, t)
        )
        self.b = DualQuaternion(
            sophus.Quaternion(y, u), sophus.Quaternion(z, v)
        )
