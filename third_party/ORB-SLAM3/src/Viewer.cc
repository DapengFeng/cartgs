...
//     pangolin::Var<bool> menuShowInertialGraph("menu.Show Inertial
//     Graph",true,true); pangolin::Var<bool>
...
//     false, true pangolin::Var<bool> menuStep("menu.Step",false,false);
...
//     if(mpTracker->mSensor == mpSystem->MONOCULAR || mpTracker->mSensor ==
//     mpSystem->STEREO || mpTracker->mSensor == mpSystem->RGBD)
//     {
//         menuShowGraph = true;
//     }
...
//             s_cam.SetModelViewMatrix(pangolin::ModelViewLookAt(0,0.01,50,
//             0,0,0,0.0,0.0, 1.0)); s_cam.Follow(Ow);
//         }
...
//         // Apply viewpointm, clear (for update), draw the current pose, draw
//         kfs, draw mps d_cam.Activate(s_cam);
...
//         if(both){
//             cv::Mat imRight =
//             mpFrameDrawer->DrawRightFrame(trackedImageScale);
